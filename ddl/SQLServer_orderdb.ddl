...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Ground Beef',5,'1 lbs',2200.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Canned Chickpeas',4,'1 can 500 gm',2135.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Strawberry Jam',2,'12 - 8 oz jars',2500.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Dried Mango',4,'12 - 1 lb pkgs.',3000.00);
...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Orange Jam',7,'30 gift boxes',8100.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cookie and Cream Scones',7,'24 pkgs. x 4 pieces',1000.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Shortbread',8,'24 - 500 g pkgs.',21.00);
...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Clams',6,'12 - 12 oz cans',900.65);
...
UPDATE Product SET productImageURL = 'img/jam.jpeg' WHERE ProductId = 6;
UPDATE Product SET productImageURL = 'img/driedmango.jpeg' WHERE ProductId = 7;
UPDATE Product SET productImageURL = 'img/Northwoods.jpeg' WHERE ProductId = 8;
UPDATE Product SET productImageURL = 'img/kobe.jpeg' WHERE ProductId = 9;
UPDATE Product SET productImageURL = 'img/Ikura.jpeg' WHERE ProductId = 10;
UPDATE Product SET productImageURL = 'img/Queso.jpeg' WHERE ProductId = 11;
UPDATE Product SET productImageURL = 'img/QuesoLaPastora.jpeg' WHERE ProductId = 12;
...
UPDATE Product SET productImageURL = 'img/orangejam.jpeg' WHERE ProductId = 19;
UPDATE Product SET productImageURL = 'img/Scones.jpeg' WHERE ProductId = 20;
UPDATE Product SET productImageURL = 'img/Knackebrod.jpeg' WHERE ProductId = 21;
UPDATE Product SET productImageURL = 'img/Ale.jpeg' WHERE ProductId = 22;
UPDATE Product SET productImageURL = 'img/Stout.jpeg' WHERE ProductId = 23;
UPDATE Product SET productImageURL = 'img/Sill.jpeg' WHERE ProductId = 24;
UPDATE Product SET productImageURL = 'img/BostonCrab.jpeg' WHERE ProductId = 25;
UPDATE Product SET productImageURL = 'img/Clams.jpeg' WHERE ProductId = 26;
